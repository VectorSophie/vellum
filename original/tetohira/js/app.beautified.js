...
(t => {
    ...
    }, l.FONTS = ["Shippori Antique", "Sawarabi Gothic", "Kaisei Opti"], l.COLORS = [989213, 13967691], l.COLORS_TITLE = [2835025, 13967691];
    var h = l;
    ...
    I = a.CustomMainBase, __extends(k, I), Object.defineProperty(k.prototype, "audio", {
        ...
        if (0 < i)
            for (var o = 0; o < i; o++) {
                ...
                null != j.toNumFromStr(r) && n.push(r)
            }
        return n
