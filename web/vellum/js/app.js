...
(t => {
    ...
    a.Context = u, r.URL = document.querySelector('meta[property="og:url"]').getAttribute("content"), r.TITLE = "벨륨", r.HASH = "#" + document.title, r.RESOLUTIONS = {
    ...
    }, r.FILENAME = "vellum", r.BPM = 130, r.BEAT = 16, r.PATH_BGM = "data/bgm.mp3", r.KEY_BGM = "bgm", r.MAX_HIRAGANAS = 50, r.DRAW_FIX_TIME_PC = 800, r.DRAW_FIX_TIME_SP = 700, r.COLOR_DRAW = 16281219, r.COLOR_DRAW_VIEW = 16281219, r.VOICE_SUB_NUM = 5, r.HIRA_BASE_OFFSET = 0, r.HIRA = {
        "あ": {
            off: [0, 0, 0, 0, 0, 0],
        ...
        return t
    }), !0), r.IS_LOCAL = location.href.indexOf("aidn.jp") < 0, r.DOMAIN_COM = "/";
    var d = r;
    ...
    I = a.CustomMainBase, __extends(k, I), Object.defineProperty(k.prototype, "audio", {
        ...
        var t = parseInt(document.querySelector("body").getAttribute("data-dom")),
            ...
            t = (d.IS_LOCAL || 1 != t || (u.domain = d.DOMAIN_COM), 0 < e && (u.cache = "?" + e), this._ytMng = new z, this._recorder = new N, s.isMobile || !document.getElementById("qrcode") || new QRCode(document.getElementById("qrcode"), {
                text: d.URL,
                colorDark: "#ffffff",
                colorLight: "#00000000",
                width: 128,
        ...
        t = "「" + this._hiraganas.join("") + "」", t = this._addSpan(t, 6) + "　<span>" + d.HASH + "</span>", $("#share_text .text").html(t), t = d.URL + this._addSpan(this._getShareUrl(!0), 6);
        ...
        var t = "\n";
        return 0 < this._hiraganas.length && (t += "「" + this._hiraganas.join("") + "」　"), t = (t += d.HASH) + ("\n" + this._getShareUrl())
